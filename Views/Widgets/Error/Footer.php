...
<svg id="sprite_SiteName" xmlns="http://www.w3.org/2000/svg"
     ...
     onload="wSpriteSvg.initialize(this,'<?php echo HTML::media('jsons/svgsprite.json'); ?>')"/>
<!-- Внешние css файлы-->
<link rel="stylesheet" property="stylesheet" href="<?php echo HTML::media('css/components.css'); ?>">
<link rel="stylesheet" property="stylesheet" href="<?php echo HTML::media('css/error.css'); ?>">
<!-- Внешние js файлы-->
