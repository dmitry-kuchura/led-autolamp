...
<link rel="icon" type="image/png"
      href="<?php echo HTML::media('favicons/android-chrome-192x192.png" sizes="192x192'); ?>">
...
<link rel="manifest" href="<?php echo HTML::media('manifest.json'); ?>">
<link rel="mask-icon" href="<?php echo HTML::media('favicons/safari-pinned-tab.svg'); ?>" color="#5bbad5">
<link rel="shortcut icon" href="<?php echo HTML::media('favicon.ico'); ?>">
