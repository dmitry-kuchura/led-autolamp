        ...
        <div class="widget">
            <div class="widgetHeader" style="padding-bottom: 10px;">
                <?php echo \Forms\Form::open(array('class' => 'widgetContent filterForm', 'action' => '/wezom/'.Core\Route::controller().'/index')); ?>
                    ...
                    <div class="col-md-2">
                        <?php echo \Forms\Builder::select(\Core\Support::selectData($rubrics, 'id', 'name', array('', 'Все')),
                            Core\Arr::get($_GET, 'rubric_id'), array('name' => 'rubric_id'), 'Рубрика'); ?>
                    </div>
                    <div class="col-md-2">
                        <?php echo \Forms\Builder::input(array(
                            'name' => 'date_s',
                    ...
                    <div class="col-md-2">
                        <?php $options = array('' => 'Все', 0 => 'Да', 1 => 'Нет'); ?>
                        <?php echo \Forms\Builder::select($options, Core\Arr::get($_GET, 'watched', 2), array(
                            'name' => 'watched',
                        ), 'Новые'); ?>
                    </div>
                    <div class="col-md-2">
