                    ...
                    <table class="table table-striped table-hover checkbox-wrap ">
                        ...
                        <?php foreach ($result as $obj): ?>
                            <tr data-id="<?php echo $obj->id; ?>">
                                ...
                                <td>
                                    <a href="/wezom/<?php echo Core\Route::controller(); ?>/edit/<?php echo $obj->id ?>"><?php echo $obj->mark; ?></a>
                                </td>
                                <td>
                                    <a href="/wezom/<?php echo Core\Route::controller(); ?>/edit/<?php echo $obj->id ?>"><?php echo $obj->model; ?></a>
                                </td>
                                <td>
                                    <a href="/wezom/<?php echo Core\Route::controller(); ?>/edit/<?php echo $obj->id ?>"><?php echo $obj->engine; ?></a>
                                </td>
                                <td>
                                    <a href="/wezom/<?php echo Core\Route::controller(); ?>/edit/<?php echo $obj->id ?>"><?php echo $obj->year; ?></a>
                                </td>
                                <td>
