                                ...
                                <ul class="table-controls">
                                    <li>
                                        ...
                                        <ul class="dropdownMenu pull-right">
                                            <li>
                                                <a title="Редактировать" href="<?php echo '/wezom/seo_files/edit/'.urlencode(base64_encode($val)); ?>"><i class="fa-pencil"></i> Редактировать</a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a title="Удалить" onclick="return confirm('Это действие необратимо. Продолжить?');" href="<?php echo '/wezom/seo_files/delete/'.urlencode(base64_encode($val)); ?>"><i class="fa-trash-o text-danger"></i> Удалить файл</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
